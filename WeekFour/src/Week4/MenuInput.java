...
public class MenuInput {
	...
	private static List<String> options = Arrays.asList("Vanilla", "Chocolate", "Mint Chocolate Chip",
			"Strawberry", "Black Raspberry", "Chocolate Peanut Butter Cup", "Bubble Gum", "Banana Fudge", "End of Ice Cream Selection");
	...
	// **********************************************************
		...
		while(!finished) {
			...
			if(willOrderIceCream) {
				...
				if(size == maxScoops) {
					System.out.println("With 3 Ice Cream flavors, the siz you get is: LARGE");
					...
					System.out.println("The size you have chosen is: ");
